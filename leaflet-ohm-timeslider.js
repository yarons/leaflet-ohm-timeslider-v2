...
L.Control.OHMTimeSlider.Translations['he'] = {
    close: "לסגור את הלוח הזה",
    expandcollapse_title: "להגדיל או למזער את הלוח",
    slider_description: "נא לבחור את התאריך להצגה על המפה",
    daterange_min_month_title: "טווח מחוון, נא לבחור חודש כהתחלה",
    daterange_min_day_title: "טווח מחוון, נא לבחור יום כהתחלה",
    daterange_min_year_title: "טווח מחוון, נא לבחור שנה כהתחלה",
    daterange_min_cebce_title: "טווח מחוון, נא לבחור שנה כהתחלה לפנה״ס או לספירה",
    daterange_max_month_title: "טווח מחוון, נא לבחור חודש כסיום",
    daterange_max_day_title: "טווח מחוון, נא לבחור יום כסיום",
    daterange_max_year_title: "טווח מחוון, נא לבחור שנה כסיום",
    daterange_max_cebce_title: "טווח מחוון, נא לבחור שנה כסיום לפנה״ס או לספירה",
    daterange_submit_text: "הגדרה",
    daterange_submit_title: "החלת הגדרות",
    range_title: "טווח",
    stepamount_title: "זמן קפיצה",
    stepamount_selector_title: "כמה זמן לקדם בכל צעד",
    stepamount_1day: "יום",
    stepamount_1month: "חודש",
    stepamount_1year: "שנה",
    stepamount_10year: "10 שנים",
    stepamount_100year: "100 שנה",
    stepinterval_title: "מהירות",
    stepinterval_selector_title: "באיזו תכיפות לדלג קדימה",
    stepinterval_5sec: "5 שניות",
    stepinterval_2sec: "2 שניות",
    stepinterval_1sec: "שנייה",
    playbutton_title: "הרצה",
    pausebutton_title: "השהיה",
    forwardbutton_title: "דילוג קדימה",
    backwardbutton_title: "דילוג אחורה",
    resetbutton_title: "חזרה לתחילת הטווח",
    autoplay_submit_text: "הגדרה",
    autoplay_submit_title: "החלת הגדרות",
    datepicker_month: "חודש",
    datepicker_day: "יום",
    datepicker_year: "שנה",
    datepicker_cebce: "לפנה״ס/לספירה או לפני הספירה/לספירה",
    datepicker_submit_text: "עדכון תאריך",
    datepicker_cancel_text: "ביטול",
    datepicker_title: "שינוי תאריך",
    datepicker_format_text: "תבניות תאריכים",
    datepicker_text: "נא למלא תאריך חדש לעדכון מקום הידית והנתונים המוצגים.",
    months: ['ינואר', 'פברואר', 'מרץ', 'אפריל', 'נאי', 'יוני', 'יולי', 'אוגוסט', 'ספטמבר', 'אוקטובר', 'נובמבר', 'דצמבר'],
    ymd_placeholder_short: "dd/mm/yyyy",
};
